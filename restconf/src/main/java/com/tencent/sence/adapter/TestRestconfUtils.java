...
public final class TestRestconfUtils {
  ...
  public static SchemaContext loadSchemaContext(
      final String yangPath, final SchemaContext schemaContext) {
    try {
      ...
      if (schemaContext == null) {
        ...
        throw new UnsupportedOperationException(
            "Unable to add new yang sources to existing schema context.");
      }
  ...
  @SuppressWarnings("checkstyle:IllegalCatch")
  public static NormalizedNodeContext loadNormalizedContextFromXmlFile(
      final String pathToInputFile, final String uri, final SchemaContext schemaContext) {
  ...
  private static NormalizedNode<?, ?> parse(
      final InstanceIdentifierContext<?> iiContext, final Document doc)
    ...
    final XmlParserStream xmlParser =
        XmlParserStream.create(writer, iiContext.getSchemaContext(), schemaNode);
  ...
  public static Collection<File> loadFiles(final String resourceDirectory)
